...
document.addEventListener('DOMContentLoaded', () => {
  ...
  document.getElementById('lang-fr').addEventListener('click', (e) => { e.preventDefault(); setLanguage('fr'); window.location.reload(); });
  document.getElementById('lang-zh').addEventListener('click', (e) => { e.preventDefault(); setLanguage('zh'); window.location.reload(); });
  document.getElementById('lang-ja').addEventListener('click', (e) => { e.preventDefault(); setLanguage('ja'); window.location.reload(); });
  document.getElementById('lang-ru').addEventListener('click', (e) => { e.preventDefault(); setLanguage('ru'); window.location.reload(); });
